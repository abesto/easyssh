...
//func TestExternalGetsCommand(t *testing.T) {
//	withMockInMakerMap(func() {
//		e := Make("(assert-command (mock))").(*external)
//		targets := target.GivenTargets("foo", "bar")
...
//}
//
//func TestExternalGetsNoCommand(t *testing.T) {
//	withMockInMakerMap(func() {
//		e := Make("(assert-command (mock))").(*external)
//		targets := target.GivenTargets("foo", "bar")
//		command := []string{}
...
//	withMockInMakerMap(func() {
//		e := Make("(assert-no-command (mock))").(*external)
//		targets := target.GivenTargets("foo", "bar")
//		command := []string{}
//
//		m := e.child.(*mockExecutor)
